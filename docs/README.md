...
| [`../.github/README.md`](../.github/README.md) | **Manual del pipeline**: el día a día en cinco pasos, qué hace cada workflow, cómo se promociona a producción y qué comprobar |
...
UUID que Moodle tiene incrustado no se mueve ([ADR-025](decisiones.md)). El administrador
puede hacer lo mismo desde la consola sobre una **biblioteca del centro** compartida con
todos los profesores del aula ([ADR-026](decisiones.md)) — el primer camino de escritura
