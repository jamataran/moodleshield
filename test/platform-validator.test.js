...
test('normaliza extremos invisibles y deduplica deployment_id', () => {
  ...
  assert.deepEqual(result.deploymentIds, ['3', '4'])
})
...
test('reconoce destinos SSRF privados y link-local', () => {
  for (const address of ['127.0.0.1', '10.2.3.4', '172.16.0.1', '192.168.1.4', '169.254.169.254', '::1', 'fd00::1', 'fe80::1']) {
